...
The tools below need to run project:

- Go (1.20 or newer) - [install](https://go.dev/doc/install)
- Migrate CLI - [install](https://github.com/golang-migrate/migrate/tree/master/cmd/migrate)
- Swag CLI - [install](https://github.com/swaggo/swag#getting-started)
...
Server handler layer (MVC controllers). The template shows 1 server:

- REST http (Echo framework)
